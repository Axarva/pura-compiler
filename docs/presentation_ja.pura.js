...
const viewTitle = function(idx) { return slideWrapper([PuraRuntime.elem('h1')([PuraRuntime.attr('class')("title main-title")])([PuraRuntime.text("Pura")]), PuraRuntime.elem('p')([PuraRuntime.attr('class')("subtitle main-subtitle")])([PuraRuntime.text("UI指向関数型言語")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("title-info")])([PuraRuntime.elem('p')([])([PuraRuntime.text("情報メディア特別演習 I")]), PuraRuntime.elem('p')([])([PuraRuntime.text("202513228　ティムシナ　アサルヴァ")]), PuraRuntime.elem('p')([])([PuraRuntime.text("アドバイザー教員：中井央")])])]); };
const viewProblemJS = function(idx) { return slideWrapper([PuraRuntime.elem('h1')([])([PuraRuntime.text("課題：実行時の脆弱性")]), PuraRuntime.elem('p')([PuraRuntime.attr('class')("subtitle")])([PuraRuntime.text("動的型付けが引き起こす静かなる失敗")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("two-column")])([PuraRuntime.elem('div')([])([PuraRuntime.elem('p')([])([PuraRuntime.text("JavaScriptの場合 (実行時エラー)")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("code-block")])([line([kw("function"), norm(" calc(cart) {")]), line([norm("  "), kw("let"), norm(" total "), kw("="), norm(" 0;")]), line([norm("  "), kw("for"), norm(" ("), kw("let"), norm(" item "), kw("of"), norm(" cart.items) {")]), line([norm("    "), redCmt("// バグ: \"10\" + 0 = \"010\"")]), line([norm("    total "), kw("+="), norm(" item.price;")]), line([norm("  }")]), line([norm("  "), kw("return"), norm(" total;")]), line([norm("}")])])]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("hidden-block")])([PuraRuntime.elem('p')([])([PuraRuntime.text(".")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("code-block")])([line([norm(" ")])])])])]); };
const viewProblemPura = function(idx) { return slideWrapperStable([PuraRuntime.elem('h1')([])([PuraRuntime.text("課題：実行時の脆弱性")]), PuraRuntime.elem('p')([PuraRuntime.attr('class')("subtitle")])([PuraRuntime.text("動的型付けが引き起こす静かなる失敗")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("two-column")])([PuraRuntime.elem('div')([])([PuraRuntime.elem('p')([])([PuraRuntime.text("JavaScriptの場合 (実行時エラー)")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("code-block")])([line([kw("function"), norm(" calc(cart) {")]), line([norm("  "), kw("let"), norm(" total "), kw("="), norm(" 0;")]), line([norm("  "), kw("for"), norm(" ("), kw("let"), norm(" item "), kw("of"), norm(" cart.items) {")]), line([norm("    "), redCmt("// バグ: \"10\" + 0 = \"010\"")]), line([norm("    total "), kw("+="), norm(" item.price;")]), line([norm("  }")]), line([norm("  "), kw("return"), norm(" total;")]), line([norm("}")])])]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("fragment visible")])([PuraRuntime.elem('p')([])([PuraRuntime.text("一方、Puraで同じコードを書くと...")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("code-block")])([line([kw("let"), fn(" calc"), norm(" "), kw("="), norm(" total "), kw("=>"), norm(" price "), kw("=>")]), line([norm("  total "), kw("+"), norm(" price")])]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("error-box")])([PuraRuntime.elem('div')([PuraRuntime.attr('class')("error-title")])([PuraRuntime.text("🛑 Type Mismatch Error")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("error-msg")])([PuraRuntime.text("Cannot add types Int and String.")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("error-detail")])([PuraRuntime.text("  | total + price")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("error-detail")])([PuraRuntime.text("  |         ^^^^^ Expected Int, got String")])])])])]); };
...
const viewEffectsStep = function(step) { return (((wrapper) => wrapper([PuraRuntime.elem('h1')([])([PuraRuntime.text("副作用の管理 (Effects)")]), PuraRuntime.elem('ul')([])([PuraRuntime.elem('li')([PuraRuntime.attr('class')("visible")])([PuraRuntime.text("JavaScriptやPythonとは異なり、副作用は明示的です。")]), PuraRuntime.elem('li')([PuraRuntime.attr('class')("visible")])([PuraRuntime.text("関数は必要な「権限」を宣言しなければなりません。")])]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("effects-grid")])([PuraRuntime.elem('div')([PuraRuntime.attr('class')((((step >= 1)) ? ("effect-card visible") : ("effect-card hidden-block")))])([PuraRuntime.elem('div')([PuraRuntime.attr('class')("col-header")])([PuraRuntime.text("1. 純粋関数")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("code-block small-code")])([line([cmt("-- xの入力に対して計算を行いその結果を出す（単射）")]), line([kw("let"), fn(" double"), norm(" "), kw("="), norm(" x "), kw("=>")]), line([norm("  x "), kw("*"), norm(" 2")])])]), PuraRuntime.elem('div')([PuraRuntime.attr('class')((((step >= 1)) ? ("effect-card visible") : ("effect-card hidden-block")))])([PuraRuntime.elem('div')([PuraRuntime.attr('class')("col-header")])([PuraRuntime.text("2. 一般的な副作用")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("code-block small-code")])([line([cmt("-- 画面で文字を表示する外部世界へのアクセス")]), line([kw("let"), fn(" log"), norm(" "), kw("="), norm(" msg "), kw("=>")]), line([fn("  print"), norm(" msg")])])]), PuraRuntime.elem('div')([PuraRuntime.attr('class')((((step >= 2)) ? ("effect-card fragment visible") : ("effect-card hidden-block")))])([PuraRuntime.elem('div')([PuraRuntime.attr('class')("col-header")])([PuraRuntime.text("3. 危険な副作用")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("code-block small-code")])([line([cmt("-- 国際的副作用")]), line([kw("let"), fn(" nuke"), norm(" "), kw("="), norm(" () "), kw("=>")]), line([fn("  launchMissiles"), norm(" ()")])])]), PuraRuntime.elem('div')([PuraRuntime.attr('class')((((step >= 2)) ? ("effect-card fragment visible") : ("effect-card hidden-block")))])([PuraRuntime.elem('div')([PuraRuntime.attr('class')("col-header")])([PuraRuntime.text("4. Puraの解決策")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("code-block small-code")])([line([cmt("-- 権限を宣言したPuraコード")]), line([kw("let"), fn(" main"), norm(" "), kw("="), norm(" { ... }")]), line([kw("  REQUIRES"), norm(" Console")])])])])]))((((step === 1)) ? (slideWrapper) : (slideWrapperStable)))); };
...
const viewSummary = function(idx) { return slideWrapper([PuraRuntime.elem('h1')([PuraRuntime.attr('class')("title")])([PuraRuntime.text("まとめ")]), PuraRuntime.elem('div')([PuraRuntime.attr('class')("two-column")])([PuraRuntime.elem('div')([])([PuraRuntime.elem('div')([PuraRuntime.attr('class')("col-header center-text")])([PuraRuntime.text("課題と解決")]), PuraRuntime.elem('ul')([])([PuraRuntime.elem('li')([PuraRuntime.attr('class')("fragment visible")])([PuraRuntime.text("動的型付けで「静かなる失敗」排除")]), PuraRuntime.elem('li')([PuraRuntime.attr('class')("fragment visible")])([PuraRuntime.text("宣言的記述で状態管理バグを防ぐ")]), PuraRuntime.elem('li')([PuraRuntime.attr('class')("fragment visible")])([PuraRuntime.text("JavaScriptより読みやすい表現")])])]), PuraRuntime.elem('div')([])([PuraRuntime.elem('div')([PuraRuntime.attr('class')("col-header center-text")])([PuraRuntime.text("技術と実証")]), PuraRuntime.elem('ul')([])([PuraRuntime.elem('li')([PuraRuntime.attr('class')("fragment visible")])([PuraRuntime.text("型推論とエフェクトシステムで安全性")]), PuraRuntime.elem('li')([PuraRuntime.attr('class')("fragment visible")])([PuraRuntime.text("MVUアーキテクチャでのUI構築を実現")]), PuraRuntime.elem('li')([PuraRuntime.attr('class')("fragment visible")])([PuraRuntime.text("実証：このスライド自体Pura製アプリ")])])])]), PuraRuntime.elem('p')([PuraRuntime.attr('class')("copyright")])([PuraRuntime.text("Built with Pura Compiler 2025")])]); };
